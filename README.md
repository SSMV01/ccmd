...
If you have a suggestion that would improve the project, please fork the repo, make your changes and create a pull request. You can also simply open an issue with the tag "enhancement".
